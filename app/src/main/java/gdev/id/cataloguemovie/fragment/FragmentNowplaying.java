...
public class FragmentNowplaying extends Fragment implements MovieView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = BuildConfig.URL_MOVIE_NOW_PLAYING;
    ...
    public void onLoadError(String message) {
        Utils.showNotificationNetworkError(getActivity
                (), linearLayout, tvMessage, message);
    }
}