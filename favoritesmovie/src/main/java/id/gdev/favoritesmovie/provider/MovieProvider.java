package id.gdev.favoritesmovie.provider;
...
import id.gdev.favoritesmovie.db.helper.MovieHelper;

import static id.gdev.favoritesmovie.db.contract.MovieContract.AUTHORITY;
